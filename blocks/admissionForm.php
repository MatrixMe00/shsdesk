                            ...
                            <div class="body">
                                <fieldset id="enrol_field">
                                    ...
                                    <div class="joint">
                                        ...
                                        <div class="label flex-column" for="ad_index">
                                            <label for="ad_index">
                                                <span class="label_image">
                                            ...
                                            <span class="item-event info">JHS Index Number</span>
                                        </div>                                        
                                        <div class="label flex-column">
                                ...
                                <fieldset>
                                    ...
                                    <div class="joint">
                                        ...
                                        <div class="label flex-column">
                                            ...
                                            <span class="item-event info">
                                                Which town is your JHS located?
                                            </span>
                                        </div>
                                        <div class="label flex-column">
                                            <label for="ad_jhs_district">
                                                ...
                                                title="Enter the name of your JHS's district">
                                            </label>
                                            <span class="item-event info">
                                                Which district is your JHS found?
                                            </span>
                                        </div>
                                    </div>
                                </fieldset>
                                        ...
                                        <div class="label flex-column">
                                            <label for="ad_year">
                                                ...
                                                <select name="ad_year" id="ad_year" ng-model="ad_year" ng-click="birthDateArrange()" required>
                                                    ...
                                                    <?php 
                                                    $first_year = intval(date("Y")) - 30;
                                                    $last_year = intval(date("Y")) - 5;
                            ...
                            <div class="body">
                                ...
                                <fieldset>
                                    ...
                                    <div class="label flex-column">
                                        ...
                                        <span class="item-event info">
                                            Awards Won [Separate each by a comma]
                                        </span>
                                    </div>
                                    <div class="label flex-column">
                                        ...
                                        <span class="item-event info">
                                            Position held in JHS [separate each by commas]
                                        </span>
                                    </div>                                    
                                </fieldset>
