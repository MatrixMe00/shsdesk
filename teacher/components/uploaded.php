...
<section id="content_wrapper">
    ...
    <?php 
        ...
        //leave all arrays in indexes
        if(is_array($approved_results) && array_key_exists("program_name",$approved_results)){
            $approved_results = [$approved_results];
        }
        if(is_array($pending_results) && array_key_exists("program_name",$pending_results)){
            $pending_results = [$pending_results];
        }
        if(is_array($rejected_results) && array_key_exists("program_name",$rejected_results)){
            $rejected_results = [$rejected_results];
        }
        if(is_array($saved_results) && array_key_exists("program_name",$saved_results)){
