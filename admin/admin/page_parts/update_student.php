    ...
    <div class="body">
        ...
        <div class="joint">
            <label for="student_index">
                ...
                autocomplete="false" placeholder="Index Number*" title="Enter the index number of the student here">
            </label>
            <label for="lname">
                <span class="label_image">
                    <img src="<?php echo $url?>/assets/images/icons/person-outline.svg" alt="lname">
                </span>
                <input type="text" name="lname" id="lname" required autocomplete="false" placeholder="Lastname*"
            ...
            <!-- <label for="fname">
                ...
                autocomplete="false" placeholder="Firstname*" title="Enter the firstname of the student">
            </label> -->
            <label for="oname">
                <span class="label_image">
                ...
                autocomplete="false" placeholder="Other Name(s)" title="Enter other names of the student">
            </label>
            <label for="gender">
                <span class="label_image">
        ...
        <div class="joint">
            <label for="student_course">
                ...
                autocomplete="false" placeholder="Enter the selected course*" required>
            </label>
            <label for="aggregate">
                <span class="label_image">
                ...
                maxlength="2" minlength="2" title="Enter the aggregate score of the student here" autocomplete="false" placeholder="Aggregate Score">
            </label>
            <label for="jhs">
                <span class="label_image">
                ...
                autocomplete="false" placeholder="JHS School Attended*">
            </label>
            <label for="dob">
                <span class="label_image">
                ...
                autocomplete="false" placeholder="Student's Birthday (mm-dd-yyyy)*">
            </label>
            <label for="track_id">
                <span class="label_image">
                ...
                autocomplete="false" placeholder="Student's Track Id*">
            </label>
        </div>
    </div>
    <div class="foot flex">
