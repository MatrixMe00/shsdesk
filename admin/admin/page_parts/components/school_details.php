<form action="<?php echo $url?>/admin/admin/submit.php" method="post" name="admissiondetailsForm" enctype="multipart/form-data">
    <div class="body">
        ...
        <div class="joint">
            <label for="admission_year">
                ...
                <div class="flex flex-column" style="flex:1">
                    <input type="text" readonly name="admission_year" id="admission_year" class="text_input" placeholder="Admission" autocomplete="off"
            ...
            <label for="academic_year">
                ...
                <div class="flex flex-column" style="flex:1">
                    ...
                    title="Enter the current academic year" maxlength="11" minlength="9" value="<?php echo $row["academicYear"] ?? getAcademicYear(now(), false) ?>">
        ...
        <?php $serial_prefix = json_decode($row["letter_prefix"] ?? "", true) ?? [] ?>
        
        <label for="letter_prefix" class="checkbox">
            <input type="checkbox" name="letter_prefix" id="letter_prefix" <?= $serial_prefix ? "checked" : "" ?> />
            <span class="label_title">Add Prefix & Serial Number to Admission Letters</span>
        </label>

        <div id="prefix-container" class="<?= $serial_prefix ? "" : "no_disp" ?>">
            <div class="joint">
                <!-- Prefix -->
                ...
                <label for="prefix_year" class="flex flex-column gap-sm sm-xlg-b">
                    ...
                    <select name="prefix_year" id="prefix_year" class="sp-med" 
                        ...
                        <option value="YYYY" <?= $serial_prefix && $serial_prefix["year"] == "YYYY" ? "selected" : "" ?> data-current-year="<?= date("Y") ?>">YYYY (<?= date("Y") ?>)</option>
                        <option value="YY" <?= $serial_prefix && $serial_prefix["year"] == "YY" ? "selected" : "" ?> data-current-year="<?= date("y") ?>">YY (<?= date("y") ?>)</option>
                        <option value="" <?= $serial_prefix && $serial_prefix["year"] == "" ? "selected" : "" ?> data-current-year="">No Year</option>
                    </select>
                </label>
                ...
                <label for="prefix_separator" class="flex flex-column gap-sm sm-xlg-b">
                    ...
                    <select name="prefix_separator" id="prefix_separator" class="sp-med" 
                        ...
                        <option value="-" <?= $serial_prefix && $serial_prefix["separator"] == "-" ? "selected" : "" ?>>Hyphene (-)</option>
                        <option value="/" <?= $serial_prefix && $serial_prefix["separator"] == "/" ? "selected" : "" ?>>Slash (/)</option>
                    </select>
                </label>
            </div>
        ...
        <div class="flex">
            <label for="admission_template" class="file_label w-full">
            ...
            <?php if($schoolDetail["admission_template"]): ?>
                <span class="item-event remove-template self-align-center w-fit">Remove Template</span>
            <?php endif; ?>
        </div>
        <div class="message_box no_disp">
            <span class="message">Here is a test message</span>
