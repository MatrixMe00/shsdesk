<nav class="<?= intval(date("H")) >= 18 ? "dark" : "primary" ?>">
    ...
    <div class="nav_links">
        ...
        <div class="buttons">
            ...
            <div data-href="<?= "$url/pages/subjects.php" ?>" class="tab" data-document-title="<?= $student["Lastname"] ?> Subjects"
                data-active="subject">
            ...
            <div data-href="<?= "$url/pages/profile.php" ?>" class="tab" data-document-title="<?= $student["Lastname"] ?> Profile" data-active="profile">
